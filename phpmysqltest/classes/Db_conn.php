...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'spdennis';//this will be your WCC username
      $dbUsr = 'spdennis';//this will be your WCC username
      $dbPass = 'GeJa679XbRuS';//this will be the password found in the video.
